            ...
            <tbody>
              ...
              <tr v-if="group">
                ...
                <td class="block border-b-2 border-gray-200 px-5 pb-5 pt-2 sm:table-cell sm:p-5">
                  <div class="flex">
                    <input v-model="searchIndex" autocomplete="off"
                           class="mr-3 block w-32 border-2 border-gray-200 px-5 py-3 opacity-75 focus:!border-blue-900 focus:!text-blue-900 focus:!ring-0 sm:w-48"
                    >
            ...
            <TableWrapper class="mt-10">
              ...
              <template #body>
                <TableRow v-for="student in students" :key="student">
                  <TableCell class="size-[50px] min-w-[50px] border-2 text-center font-bold">
                    {{ student.student }}
                  </TableCell>
                  <TableCell v-for="grade in student.grades" :key="grade"
                             :class="{'bg-lime-200': grade.present === true, 'bg-rose-300': grade.present === false}"
